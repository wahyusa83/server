...
{
  // Warnings
  sp_condition("NO_DATA_FOUND"_Lex_ident_sp_var, &cond_no_data_found),
  // Errors
  sp_condition("INVALID_CURSOR"_Lex_ident_sp_var, &cond_invalid_cursor),
  sp_condition("DUP_VAL_ON_INDEX"_Lex_ident_sp_var, &cond_dup_val_on_index),
  sp_condition("DUP_VAL_ON_INDEX"_Lex_ident_sp_var, &cond_dup_val_on_index2),
  sp_condition("TOO_MANY_ROWS"_Lex_ident_sp_var, &cond_too_many_rows)
};
