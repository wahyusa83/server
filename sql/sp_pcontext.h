...
public:
  sp_condition(const Lex_ident_sp_var &name_arg, sp_condition_value *value_arg)
   :Sql_alloc(),
    name(name_arg),
    value(value_arg)
  { }
...
*/
class sp_pcursor: public Lex_ident_sp_var
{
...
public:
  sp_pcursor(const LEX_CSTRING *name, class sp_pcontext *param_ctx,
   ...
   :Lex_ident_sp_var(*name), m_param_context(param_ctx), m_lex(lex)
  { }
...
public:
  ...
  */
  ...
  bool add_condition(THD *thd, const Lex_ident_sp_var &name,
                               sp_condition_value *value);
  ...
  bool declare_condition(THD *thd, const Lex_ident_sp_var &name,
