...
*/
bool Lex_exact_charset_opt_extended_collate::
  merge_context_collation_override(Charset_collation_map_st::Used *used,
...
bool Lex_extended_collation_st::merge_exact_charset(Charset_collation_map_st::Used *used,
                                                    const Charset_collation_map_st &map,
...
CHARSET_INFO *Lex_exact_charset_extended_collation_attrs_st::
                resolved_to_character_set(Charset_collation_map_st::Used *used,
                                          const Charset_collation_map_st &map,
...
bool Lex_exact_charset_extended_collation_attrs_st::
       merge_context_collation(Charset_collation_map_st::Used *used,
                               const Charset_collation_map_st &map,
                               const Lex_context_collation &cl)
{
  switch (m_type) {
...
bool Lex_exact_charset_extended_collation_attrs_st::
       merge_collation(Charset_collation_map_st::Used *used,
                       const Charset_collation_map_st &map,
...
*/
bool Lex_exact_charset_extended_collation_attrs_st::
       merge_exact_charset(Charset_collation_map_st::Used *used,
                           const Charset_collation_map_st &map,
                           const Lex_exact_charset &cs)
{
...
Lex_extended_charset_extended_collation_attrs_st::
  resolved_to_context(Charset_collation_map_st::Used *used,
                      const Charset_collation_map_st &map,
